...
func init() {
	...
	// Path flags
	rootCmd.Flags().String("output", "output", "path to write autogenerated files")
	rootCmd.Flags().String("overrides", "overrides", "path to override files")
	rootCmd.Flags().String("templates", "templates", "path to template files")
	...
	// Config file flag
	rootCmd.Flags().String("config", "", "path to config file (default: config.yaml in current directory)")
